...
public class PatientLocalMR extends Configured implements Tool {
	
	public static class MapDemohadoop extends Mapper<LongWritable, Text, Text, IntWritable> {
	...
	public static class Reducesenthil extends Reducer<Text, IntWritable, Text, IntWritable> {
	...
	job.setJarByClass(PatientLocalMR.class); // class conmtains mapper and
												// reducer class
	...
	int res = ToolRunner.run(new Configuration(),new PatientLocalMR(), args);
