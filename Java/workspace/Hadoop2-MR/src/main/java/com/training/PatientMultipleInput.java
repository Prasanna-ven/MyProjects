...
public class PatientMultipleInput {
	...
	public static class PatientTabMapper extends Mapper<LongWritable, Text, Text, IntWritable> 
	{
	...
	public static class PatientReducer extends Reducer<Text, IntWritable, Text, IntWritable> 
	{
        ...
        public static void main(String args[]) throws IOException, ClassNotFoundException, InterruptedException {
            ...
            job.setJarByClass(PatientMultipleInput.class);

            // set Multiple input with different mapper each
            MultipleInputs.addInputPath(job, new Path(args[0]),TextInputFormat.class, PatientMapper.class);
            MultipleInputs.addInputPath(job, new Path(args[1]),TextInputFormat.class, PatientTabMapper.class);
